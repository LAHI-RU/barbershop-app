                    ...
                    <form action="{{ route('barbers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name') }}" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="e.g. Master Giovanni" required autofocus />
                            ...
                            <div>
                                ...
                                <input id="phone" type="text" name="phone" value="{{ old('phone') }}" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="+94 XX XXX XXXX" required />
                            ...
                            <div>
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email') }}" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="artisan@barbershop.lk" />
                            ...
                            <div>
                                ...
                                <select name="is_active" id="is_active" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300">
                                    <option value="1" class="bg-gray-900 text-white" {{ old('is_active') == 1 ? 'selected' : '' }}>Available for Duty</option>
                                    <option value="0" class="bg-gray-900 text-white" {{ old('is_active') == 0 ? 'selected' : '' }}>On Sabbatical</option>
                                </select>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="bio" id="bio" rows="4" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="Describe the artisan's expertise and style...">{{ old('bio') }}</textarea>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-2 flex items-center space-x-6">
                                    <div class="flex-shrink-0 h-24 w-24 bg-black/40 rounded-2xl border-2 border-dashed border-gray-800 flex items-center justify-center text-gray-600" id="preview-placeholder">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-[10px] text-gray-500 mt-2 uppercase tracking-widest font-bold">Recommended: Square format, PNG or JPG (Max 2MB)</p>
                                    </div>
                                </div>
