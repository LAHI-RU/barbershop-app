                    ...
                    <form action="{{ route('services.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name') }}" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="e.g. The Executive Silhouette" required autofocus />
                            ...
                            <div>
                                ...
                                <select name="category" id="category" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300">
                                    <option value="Haircut" class="bg-gray-900" {{ old('category') == 'Haircut' ? 'selected' : '' }}>Haircut</option>
                                    <option value="Shave" class="bg-gray-900" {{ old('category') == 'Shave' ? 'selected' : '' }}>Shave</option>
                                    <option value="Beard Trim" class="bg-gray-900" {{ old('category') == 'Beard Trim' ? 'selected' : '' }}>Beard Trim</option>
                                    <option value="Facial" class="bg-gray-900" {{ old('category') == 'Facial' ? 'selected' : '' }}>Facial</option>
                                    <option value="Other" class="bg-gray-900" {{ old('category') == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input id="duration_minutes" type="number" name="duration_minutes" value="{{ old('duration_minutes') }}" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="45" required />
                            ...
                            <div>
                                ...
                                <input id="price" type="number" step="0.01" name="price" value="{{ old('price') }}" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="2500" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="3" class="block w-full bg-black/50 border-gray-800 text-white rounded-xl focus:border-gold focus:ring-gold transition-all duration-300 placeholder-gray-600" placeholder="Describe the sensory experience and technique...">{{ old('description') }}</textarea>
